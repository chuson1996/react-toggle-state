...
/***/ function(module, exports, __webpack_require__) {
	...
	var ToggleState = function (_Component) {
	  _inherits(ToggleState, _Component);
	  ...
	  function ToggleState(props) {
	    ...
	    _this.turnTrue = function () {
	      _this.setState({
	        data: true
	      });
	    };
	
	    _this.turnFalse = function () {
	      _this.setState({
	        data: false
	      });
	    };
	...
	ToggleState.propTypes = {
	  defaultState: _react.PropTypes.bool,
...
;
//# sourceMappingURL=react-toggle-state.map